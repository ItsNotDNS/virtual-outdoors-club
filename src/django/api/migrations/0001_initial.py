# Generated by Django 2.1.2 on 2018-11-28 21:12
...
from ..models import UserVariability, Reservation
...
def initialData(apps, schema_editor):
    ...
    # Set up users
    adminUser = User.objects.create_superuser(username="admin1", email="u@gmail.com", password="outdoorsclub", last_login=timezone.now())
    execUser = User.objects.create_user(username="executive1", email="u@gmail.com", password="outdoorsclub", last_login=timezone.now())

    # Note: All permissions are preceded by our app name, "api". ie: 'api.change_reservation'
    permissions = ["add_reservation", "view_reservation", "change_reservation",]
