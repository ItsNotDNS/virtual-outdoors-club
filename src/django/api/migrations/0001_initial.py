# Generated by Django 2.1.2 on 2018-11-30 08:12
...
def initialData(apps, schema_editor):
    ...
    # Set up users
    User.objects.create_superuser(username="admin", email="u@gmail.com", password="outdoorsclub", last_login=timezone.now())
    execUser = User.objects.create_user(username="executive", email="u@gmail.com", password="outdoorsclub", last_login=timezone.now())

    # Note: All permissions are preceded by our app name, "api". ie: 'api.change_reservation'
    permissions = ["view_reservation", "change_reservation"]
    ...
    for perm in permissions:
        ...
        execUser.user_permissions.add(p)
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('condition', models.CharField(choices=[('RENTABLE', 'Rentable'), ('FLAGGED', 'Flagged'), ('NEEDS_REPAIR', 'Needs Repair'), ('DELETED', 'Deleted')], default='RENTABLE', max_length=20)),
