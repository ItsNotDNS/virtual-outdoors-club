...
class GearStat(models.Model):
    ...
    counter = models.PositiveSmallIntegerField(default=0, validators=[MaxValueValidator(7)])
    usage = models.PositiveSmallIntegerField(default=0, validators=[MaxValueValidator(7)])
